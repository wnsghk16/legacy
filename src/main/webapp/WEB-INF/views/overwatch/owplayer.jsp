<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<main class="v-main" id="home" style="padding: 64px 0px 0px;"
	data-booted="true">
	<div class="v-main__wrap">
		<div data-v-0b4db279="">
			<div data-v-0b4db279="" class="v-card v-sheet theme--light">
				<!---->
				<div data-v-0b4db279="" class="v-card__title">
					<div data-v-0b4db279="" class="spacer"></div>
					<div data-v-0b4db279=""
						...
						<div class="v-input__control">
							<div class="v-input__slot">
								<div class="v-text-field__slot">
									<label for="input-13" class="v-label theme--light"
										style="left: 0px; right: auto; position: absolute;">Search</label><input
										id="input-13" type="text">
								</div>
				...
				<div data-v-0b4db279="" class="v-data-table theme--light">
					<div class="v-data-table__wrapper">
						<table>
							...
							<thead class="v-data-table-header">
								<tr>
									<th role="columnheader" scope="col" aria-label="PlayerImg"
										class="text-left"><span>PlayerImg</span></th>
									<th role="columnheader" scope="col"
										aria-label="Player: Not sorted. Activate to sort ascending."
										aria-sort="none" class="text-start sortable"><span>Player</span><i
										aria-hidden="true"
									...
									<th role="columnheader" scope="col"
										...
										style="font-size: 18px;"></i></th>
									<th role="columnheader" scope="col"
										aria-label="Hometown: Not sorted. Activate to sort ascending."
										aria-sort="none" class="text-start sortable"><span>Hometown</span><i
										aria-hidden="true"
										class="v-icon notranslate v-data-table-header__icon mdi mdi-arrow-up theme--light"
										style="font-size: 18px;"></i></th>
									<th role="columnheader" scope="col" aria-label="TeamImg"
										class="text-start"><span>TeamImg</span></th>
									<th role="columnheader" scope="col"
										aria-label="Team: Not sorted. Activate to sort ascending."
										aria-sort="none" class="text-start sortable"><span>Team</span><i
										aria-hidden="true"
										class="v-icon notranslate v-data-table-header__icon mdi mdi-arrow-up theme--light"
										style="font-size: 18px;"></i></th>
									<th role="columnheader" scope="col"
										aria-label="Role: Not sorted. Activate to sort ascending."
										aria-sort="none" class="text-start sortable"><span>Role</span><i
										aria-hidden="true"
										class="v-icon notranslate v-data-table-header__icon mdi mdi-arrow-up theme--light"
										style="font-size: 18px;"></i></th>
								</tr>
							...
							<tbody>
								<tr class="">
									...
									<td class="text-start">Offense</td>
								</tr>
								<tr class="">
									<td class="text-left"><div data-v-0b4db279=""
											class="v-image v-responsive image1 theme--light">
								...
								<tr class="">
									...
									<td class="text-start"><img class="image1"  data-v-0b4db279=""
										...
										class="image"></td>
									<td class="text-start">런던 스핏파이어</td>
									<td class="text-start">Support</td>
								</tr>
								<tr class="">
									<td class="text-left"><div data-v-0b4db279=""
											class="v-image v-responsive image1 theme--light">
					...
					<div class="v-data-footer">
							...
							<div
								...
								<div class="v-input__control">
									<div role="button" aria-haspopup="listbox"
										aria-expanded="false" aria-owns="list-25"
										class="v-input__slot">
										<div class="v-select__slot">
											<div class="v-select__selections">
												<div
													class="v-select__selection v-select__selection--comma">10</div>
												<input aria-label="$vuetify.dataTable.itemsPerPageText"
													id="input-25" readonly="readonly" type="text"
						...
						<div class="v-data-footer__pagination">1-10 of 210</div>
