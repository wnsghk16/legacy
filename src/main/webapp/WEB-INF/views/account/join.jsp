				...
				<div class="login-box">
					<div class="login-snip">
						...
						<div class="login-space">
							<div class="login">
								<div class="group">
									<br> <br> <br> <label for="login_id"
										class="label">UserID</label><input id="login_id" type="text"
										placeholder="Enter your UserID" class="input">
								</div>
								<div class="group">
							...
							<div class="sign-up-form">
								<div class="group">
									<br> <label for="join_id" class="label">UserID</label><input
								...
								<div class="group">
									<label for="name" class="label">Name</label><input id="name"
										type="text" placeholder="Enter your Name" class="input">
								</div>
								<div class="group">
